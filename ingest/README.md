...
`ingest` turns scanned insurance claim documents into a structured,
...
[`../examples/ingest`](../examples/ingest/README.md). They are hand-written
...
```python
from ingest.api import ClaimKbApi
...
folder_claim = kb.ingest_claim_folder(
    ...
    folder_path="examples/ingest/sample_input",
)
...
`infrastructure`; Claim KB keeps only its claim-specific OCR,
